...
//  定数定義
//--------------------------------------------------------------------------------
#define TUTORIAL_POS_X (-0.5f)//ポリゴンの表示位置X
#define TUTORIAL_POS_Y (-0.5f)//ポリゴンの表示位置Y
#define TUTORIAL_TEXTURENAME "data/TEXTURE/説明-01.png"//ファイル名
...
//  グローバル変数
//--------------------------------------------------------------------------------
LPDIRECT3DTEXTURE9 g_pTextureTutorial = NULL;//textureインターフェース
...
void InitTutorial(void)
{
	...
	if (FAILED(MakeVerTexTutorial(pDevice)))//textureポインタへのポインタ
	{
		MessageBox(NULL, "MakeVerTexTutorial ERROR!!", "エラー", MB_OK | MB_ICONWARNING);
	}
